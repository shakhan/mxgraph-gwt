/**
 * $Id: mxICell.java,v 1.8 2012-04-16 21:19:47 boris Exp $
 ...
 */
public interface mxICell extends IJavaScriptWrapper
{
	 ...
	 * 
	 * @param isVertex - boolean that specifies if the cell is a vertex.
	 */
	...
	/**
	 * Sets new value for connectable flag
	 * 
	 * @param connectable new value
	 */
	 ...
	 * @param defaultValue Optional default value to use if the attribute has no value.
	 * @return
	 */
